...
namespace Microsoft.EntityFrameworkCore.TestUtilities
{
    public class FakeStateManager : IStateManager
    {
        ...
        public Action<InternalEntityEntry, EntityState, bool> EntityStateChangedEventBridge { get; set; }

        public Action<InternalEntityEntry, EntityState, bool> EntityStateChangingEventBridge { get; set; }
